(function(app) { 
  ...
  app.AnnouncesCostView = Backbone.View.extend({

    template: JST["backbone/user_cost_announce/announces_template"],
    ...
    initialize: function() {
      ...
      this.films = new app.AnnouncesCollection();
    ...
    addOneFilm: function(model) {
      ...
      var view = new app.AnnounceCostView({model:model}),   
