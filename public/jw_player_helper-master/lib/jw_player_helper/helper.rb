  ...
  module Helper
    ...
    def video_player(flashvars, attributes = {} , params = {})
      ...
      result = %Q{<script type="text/javascript">
                    ...
                    swfobject.embedSWF('/swf/player.swf','#{attributes[:id]}','#{attributes[:width]}','#{attributes[:height]}','9','false', flashvars_#{attributes[:id]}, params_#{attributes[:id]}, attributes_#{attributes[:id]} ,{menu:"false", wmode:"opaque"})
